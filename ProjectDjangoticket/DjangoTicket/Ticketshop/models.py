...
class Match(models.Model):
    ...
    eventTime = models.DateField(default=(datetime.now() + relativedelta(months=1)).date()) # Makes it a nice DateField in the admin panel
    ...
    def save(self, *args, **kwargs):
        ...
        # For Use Case 2,  autogenerated Sectors are implemented
        if is_new:
